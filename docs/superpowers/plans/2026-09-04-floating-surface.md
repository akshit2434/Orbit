...
> Historical implementation plan. Sizes, storage limits, and architecture below reflect the plan at authoring time; see [Prototype Context](../../prototype-context.md) for current behavior.
